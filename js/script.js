...
else 
{
  ...
  if ( $(window).width() > 1023) {  
    ...
    tiles = $("h2, h3, .column-one, .column-two, .column-three, .column-four, .column-five, .column-six, .column-seven, .column-eight, .column-nine, .grid li, .contact .content .form, .contact .content .contact-text ").fadeTo(0, 0);
